...
<section class="py-3">
    <div class="container">
        <div class="row">
            ...
            <p class="lead">Se listan todos los jugadores convocados por el DT de la selección</p>
            <p class="small">Estas deacuerdo con los convocados? Qué cambios harias?.</p>
            <div>
